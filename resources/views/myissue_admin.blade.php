    ...
    <div class="row">
        <div class="col-md-4 col-lg-3">
            ...
            <div class="input-group mb-md">
                <input disabled="true" type="text" class="form-control" value="Assign To:">
                <div class="input-group-btn">
                    ...
                    <ul role="menu" class="dropdown-menu pull-right">
                        ...
                        <li><a href="{{url('/assignto/'.$data->id.'/'.$isssueid)}}">{{$data->name}} {{$data->surname}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
            <div class="input-group mb-md">
                <input value="Decision" disabled="" type="text" class="form-control">
                <div class="input-group-btn">
                    ...
                    <ul role="menu" class="dropdown-menu pull-right">
                        <li><a  href="{{url('/accept/'.$isssueid)}}">Accept</a></li>
                        <li><a  href="{{url('/pending/'.$isssueid)}}">Pending</a></li>
                        <li><a  href="{{url('/reject/'.$isssueid)}}">Declined</a></li>
                    </ul>
                </div>
            </div>
