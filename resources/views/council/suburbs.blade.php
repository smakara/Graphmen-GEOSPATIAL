    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Suburb Management</span></li>
            </ol>
        ...
        <div class="col-md-12 col-lg-12 col-xl-12">
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Suburb Management  - {{$city}}</h2>
                </header>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-md">
                                <button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#addmember">Add Suburb <i class="fa fa-plus"></i></button>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-none" id="datatable-default">
                        <thead>
                            <tr>
                                <th>Suburb</th>
                                <th>Population</th>
                                <th class="center" >Min Stand Size</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($suburbs as  $data)
                            <tr class="gradeX">
                                <td ><a href="{{url('property/'.Crypt::encrypt($data->sub_id))}}">{{$data->sub_name}}</a></td>
                                <td >{{$data->sub_population}} </td>

                                <td class="center">{{$data->sub_min_stand_size}} </td>
