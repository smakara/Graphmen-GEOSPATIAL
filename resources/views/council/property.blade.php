        ...
        <div class="col-md-12 col-lg-12 col-xl-12">
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Property Management  - {{$suburb}}</h2>
                </header>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <table class="table table-bordered table-striped mb-none" id="datatable-default">
                        <thead>
                            <tr>
                                ...
                                <th>Situation</th>
                                <th>Land Use</th>
                                <th class="center" >Stand Size</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($property as  $data)
                            <tr class="gradeX">
                                <td ><a href="{{url('property/profile/'.Crypt::encrypt($data->pro_id))}}">{{$data->pro_stand_number}}</a></td>
                                <td >{{$data->pro_owner}} </td>
                                <td >{{$data->pro_situation}} </td>
                                <td >{{$data->pro_land_use}} </td>
                                <td class="center">{{$data->pro_size}} </td>
