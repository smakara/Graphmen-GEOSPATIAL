...
//    }
//
//    public function capturedatasettings() {
//        $users = DB::table('users')
//                ->join('persons', 'persons.id', '=', 'users.person_id')
//                ->get();
//
...
//            "sectors" => $sectors
//        );
//        return view('sectorssettings', $data);
//    }
//
//    public function indicatorsettings(Request $request) {
//
//
//        $indicatorsArray = array();
//        $indicators = DB::table('indicators')
...
//
////        return $data;
//        return view('indicatorsettings', $data);
//    }
//
//    public function valuessettings(Request $request) {
//        
////        return $request;
//        
//        try {
...
//                ->where("sec_description", "=", $request->sector)
//                ->first();
//        
//
//        $indicatorsID = DB::table('indicators')->insertGetId([
//            "ind_description" => $request->indicator,
//            "ind_sector_id" => $sector->sec_id
//        ]);
//
//
//        DB::table('variables')->insertGetId([
//            "var_description" => $request->malevariable,
//            "var_ind_id" => $indicatorsID
//        ]);
//
//        DB::table('variables')->insertGetId([
//            "var_description" => $request->femalevariable,
//            "var_datatype" => "number",
//            "var_ind_id" => $indicatorsID
//        ]);
//        
...
//            $indicatorsArray = array();
//        $indicators = DB::table('indicators')
//                ->where('ind_sector_id', $sector->sec_id)
//                ->get();
//
//        foreach ($indicators as $indicator) {
//
